<div class="bg-white border border-gray-200 rounded-2xl p-4 sm:p-5 shadow-sm relative z-50" data-aos="fade-up" data-aos-delay="200">
    <form x-data="{ statut: '{{ request('statut') }}' }" action="{{ route('student.candidatures') }}" method="GET" class="flex flex-col lg:flex-row items-center gap-4">
        ...
        <div x-data="{ open: false }" class="relative inline-flex w-full lg:w-56 z-20">

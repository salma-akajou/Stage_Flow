            ...
            <div class="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-100">
                ...
                <div class="px-8 pb-8 sm:px-10 sm:pb-10">
                    ...
                    <div class="text-center mb-10 pt-4">
                        <h3 id="stu-nom-complet" class="text-3xl font-black text-gray-900 mb-2 font-heading tracking-tight leading-none">...</h3>
                        <p id="stu-email-text" class="text-xs font-bold text-indigo-500/70 tracking-widest uppercase mb-6">...</p>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                        <div class="p-4 bg-gray-50/50 rounded-3xl border border-gray-100 flex items-center gap-4">
                            ...
                            <div><p class="text-[9px] font-black text-gray-400 uppercase tracking-widest">Établissement</p><p id="stu-etablissement" class="text-xs font-black text-gray-800">...</p></div>
                        </div>
                        <div class="p-4 bg-gray-50/50 rounded-3xl border border-gray-100 flex items-center gap-4">
                            ...
                            <div><p class="text-[9px] font-black text-gray-400 uppercase tracking-widest">Localisation</p><p id="stu-ville" class="text-xs font-black text-gray-800">...</p></div>
                        </div>
                        <div class="p-4 bg-gray-50/50 rounded-3xl border border-gray-100 flex items-center gap-4">
                            ...
                            <div><p class="text-[9px] font-black text-gray-400 uppercase tracking-widest">Filière</p><p id="stu-filiere-badge" class="text-xs font-black text-gray-800">...</p></div>
                        </div>
                        <div class="p-4 bg-gray-50/50 rounded-3xl border border-gray-100 flex items-center gap-4">
                            ...
                            <div><p class="text-[9px] font-black text-gray-400 uppercase tracking-widest">Niveau</p><p id="stu-niveau-badge" class="text-xs font-black text-gray-800">...</p></div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50/50 rounded-[2.5rem] p-7 border border-gray-100/50">

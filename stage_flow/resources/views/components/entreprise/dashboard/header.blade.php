...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4" data-aos="fade-down">
    ...
    <button onclick="openOfferModal()" class="shrink-0 inline-flex items-center gap-x-2 py-3 px-5 text-sm font-bold rounded-xl bg-indigo-600 text-white hover:bg-indigo-700 shadow-lg shadow-indigo-200 transition transform hover:scale-[1.02]">

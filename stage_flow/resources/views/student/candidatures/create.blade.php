        ...
        <form action="{{ route('student.candidatures.store', $offre->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-8 relative z-10">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="tel" name="telephone" required
                            class="py-3 px-4 ps-11 block w-full border-gray-200 rounded-xl text-sm focus:border-indigo-500 focus:ring-indigo-500 shadow-sm"
                ...
                <div>
                    ...
                    <textarea name="message_motivation" required
                        class="py-3.5 px-4 block w-full border-gray-200 rounded-xl text-sm focus:border-indigo-500 focus:ring-indigo-500 transition shadow-sm"
                        rows="4"
                        placeholder="Présentez brièvement vos atouts pour ce poste, vos motivations..."></textarea>
                </div>
                ...
                <div x-data="{ fileName: '' }">
                    ...
                    <label for="cv-upload-form"
                        ...
                        <input id="cv-upload-form" name="cv" type="file" accept=".pdf" class="sr-only" required
                ...
                <!-- Portfolio Link -->
                <div>
                    <label class="block text-sm font-bold mb-2 text-gray-800">Lien du Portfolio (Optionnel)</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                ...
                <div x-data="{ photoName: '' }">
                    <label class="block text-sm font-bold mb-3 text-gray-800">Photo pour cette candidature (Optionnel)</label>
                    <label for="form-photo-upload" class="group flex items-center gap-5 cursor-pointer">
                        <div class="shrink-0 size-16 rounded-full bg-gray-100 border-2 border-dashed border-gray-300 group-hover:border-indigo-400 group-hover:bg-indigo-50 flex items-center justify-center transition-all">
                            <svg class="size-7 text-gray-400 group-hover:text-indigo-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                        </div>
                        <div>
                            <span class="block text-sm font-medium text-gray-700 group-hover:text-indigo-600 transition-colors" x-text="photoName || 'Ajouter une photo'"></span>
                            <span class="block text-xs text-gray-400 mt-0.5">JPG, PNG – Max 2MB</span>
                        </div>
                        <input id="form-photo-upload" name="photo" type="file" accept="image/*" class="hidden" @change="photoName = $event.target.files[0].name">
                    </label>
                </div>
            </div>
